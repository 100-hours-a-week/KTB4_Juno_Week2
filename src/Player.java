public class Player extends KarasunoMember {
    ...
    public static void showPlayerList() {
        ...
        System.out.println();
        System.out.println(MemberNumber.SAWAMURA + ". 사와무라 다이치 - 윙 스파이커, 캡틴");
        System.out.println(MemberNumber.SUGAWARA + ". 스가와라 코시 - 세터");
        System.out.println(MemberNumber.NISHINOYA + ". 니시노야 유 - 리베로");
        System.out.println(MemberNumber.TANAKA + ". 다나카 류노스케 - 윙 스파이커");
        System.out.println(MemberNumber.ASAHI + ". 아즈마네 아사히 - 윙 스파이커, 에이스");
        System.out.println(MemberNumber.KAGEYAMA + ". 카게야마 토비오 - 세터");
        System.out.println(MemberNumber.HINATA + ". 히나타 쇼요 - 미들 블로커, 윙 스파이커");
        System.out.println(MemberNumber.TSUKISHIMA + ". 츠키시마 케이 - 미들 블로커");
        System.out.println(MemberNumber.YACHI + ". 야치 히토카 - 매니저");
        System.out.println(MemberNumber.KIYOKO + ". 시미즈 키요코 - 매니저");
    }
